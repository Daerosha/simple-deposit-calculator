...
class AwaitingHistoryDisplayStateTest {
    ...
    @InjectMocks
    private AwaitingHistoryDisplayState awaitingHistoryDisplayStateService;

    @Test
    void shouldDisplayHistoryWithDataWhenUserEntersYes() throws IOException {
        ...
        verify(statesMachine, times(1)).setNextState(AvaibleStates.AwaitingContinueCalculatingState);
    }

    @Test
    void shouldTransitionToContinueCalculatingWithoutHistoryDisplayWhenUserEntersNo() throws IOException {
    ...
    @Test
    void shouldDisplayErrorMessageWhenIOExceptionOccursDuringInput() throws IOException {
