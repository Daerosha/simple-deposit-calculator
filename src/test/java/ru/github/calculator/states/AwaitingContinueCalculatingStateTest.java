...
class AwaitingContinueCalculatingStateTest {
    ...
    @InjectMocks
    private AwaitingContinueCalculatingState awaitingContinueCalculatingservice;

    @Test
    void shouldTransitionToAwaitingSumStateWhenUserEntersYes() throws IOException {
    ...
    @Test
    void shouldTransitionToAwaitingExitDepositCalculatorWhenUserEntersNo() throws IOException {
        ...
        verify(userIO, times(1)).postValueToUser("%nDo you want to calculate again? Type yes or no:");
        verify(userIO, times(1)).getValueFromUser();
        verify(statesMachine, times(1)).setNextState(AvaibleStates.AwaitingExitDepositCalculatorState);
    }

    @Test
    void shouldNotTransitionStateWhenUserEntersInvalidValue() throws IOException {
    ...
    @Test
    void shouldDisplayErrorAndNotTransitionStateWhenIOExceptionOccurs() throws IOException {
    ...
    @Test
    void shouldNotTransitionStateWhenUserEntersNonEnglishValue() throws IOException {
    ...
    @Test
    void shouldNotTransitionStateWhenUserEntersNumericValue() throws IOException {
    ...
    @Test
    void shouldNotTransitionStateWhenUserEntersSpecialCharacters() throws IOException {
