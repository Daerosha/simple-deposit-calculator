...
class AwaitingSaveCalculatingHistoryStateTest {
    ...
    @InjectMocks
    private AwaitingSaveCalculatingHistoryState service;
    ...
    void shouldSaveHistoryClearDataAndTransitionToDisplayWhenHandleIsCalled() {
        ...
        verify(statesMachine, times(1)).setNextState(AvaibleStates.AwaitingHistoryDisplayState);
    ...
    void shouldClearDataAndTransitionToContinueCalculatingWhenNullPointerExceptionOccurs() {
        ...
        verify(userIO, times(1)).postValueToUser("%n Viewing history is currently unavailable, but you can count again.%n");
